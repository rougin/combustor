...
class RemoveWildfireCommandTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $installCommand = 'Rougin\Combustor\Commands\InstallWildfireCommand';
        $removeCommand = 'Rougin\Combustor\Commands\RemoveWildfireCommand';
