...
use Rougin\Combustor\Doctrine\CreateControllerCommand as Doctrine;
use Rougin\Combustor\Wildfire\CreateControllerCommand as Wildfire;
...
class CreateControllerCommand extends Command
{
    ...
    protected function installWildfire($input, $output)
    {
        if ($input->getOption('camel')) {
            $message = 'Wildfire does not support camel casing!';
